...
class Session extends BaseModel
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('hall_id, film_id, date', 'required'),
			array('hall_id, film_id', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, hall_id, film_id, date, description', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'hall' => array(self::BELONGS_TO, 'CinemaHall', 'hall_id'),
			'film' => array(self::BELONGS_TO, 'Film', 'film_id'),
			'tickets' => array(self::HAS_MANY, 'Tickets', 'session_id'),
		);
	}
